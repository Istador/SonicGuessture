...
QT_MOC_LITERAL(4, 28, 5)
    ...
    "Camera\0cameraImage\0\0cv::Mat\0image\0"
};
...
void Camera::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->cameraImage((*reinterpret_cast< const cv::Mat(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Camera::cameraImage)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void Camera::cameraImage(const cv::Mat & _t1)
{
